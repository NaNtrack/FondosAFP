    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text">
              <p>Nos alegramos comunicarte que tu fondo <?php echo $fondo; ?> ha subido $<?php echo number_format($ganancia, 2); ?> desde el <?php echo $fecha ?></p>
              <p>Desde tu &uacute;ltimo cambio el dia <?php echo $from_fecha; ?> has <?php if ($ganancia_total >= 0) : ?>ganado<?php else : ?>perdido<?php endif; ?> $<?php echo number_format($ganancia_total, 2); ?></p>
            </td>
          </tr>
          <tr>
            <td class="button">
