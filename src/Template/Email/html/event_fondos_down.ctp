    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text">
              <p>Lamentamos comunicarte que tu fondo <?php echo $fondo; ?> ha bajado $<?php echo number_format($ganancia, 2); ?> desde el <?php echo $fecha ?></p>
        ...
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td style="padding: 25px 0 25px">
              <strong><a href="https://fondosafp.com">Fondos AFP</a></strong><br />
