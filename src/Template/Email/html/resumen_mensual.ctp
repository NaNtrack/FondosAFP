...
<head>
  ...
  <title>Fondos AFP - <?php echo $title; ?></title>
  ...
  <style type="text/css">
    ...
    * {font-family: Helvetica, Arial, sans-serif;}
    body {-webkit-font-smoothing: antialiased;-webkit-text-size-adjust: none;width: 100% !important;margin: 0 !important;height: 100%;color: #676767;}
    ...
    .info-img {width: 258px;border-radius: 5px 5px 0 0;}
  ...
  <style type="text/css" media="screen">
    ...
    @media screen {* {font-family: 'Oxygen', 'Helvetica Neue', 'Arial', 'sans-serif' !important;}}
  </style>
  <style type="text/css" media="only screen and (max-width: 480px)">
    @media only screen and (max-width: 480px) {
      ...
      td[class="info-img"],img[class="info-img"]{width:278px !important;}
    }
  </style>
</head>
...
<table align="center" cellpadding="0" cellspacing="0" class="container-for-gmail-android" width="100%">
                ...
                <table cellpadding="0" cellspacing="0" width="600" class="w320">
                  <tr>
                    <td class="pull-left mobile-header-padding-left" style="vertical-align: middle;">
                      <a href="https://www.fondosafp.com"><img width="123" height="30" src="https://www.fondosafp.com/img/logo.png" alt="logo"></a>
                    </td>
                    <td class="pull-right mobile-header-padding-right" style="color: #4d4d4d;">
                      <a href="https://www.twitter.com/FondosAFP"><img width="44" height="47" src="http://s3.amazonaws.com/swu-filepicker/k8D8A7SLRuetZspHxsJk_social_08.gif" alt="twitter" /></a>
    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text">
                <h2><?php echo "$afp - $fechaReporte"; ?></<h2>
                <ul>
                  <li>Fondo A: $<?php echo $data['A']['valor']; ?> <?php echo $data['A']['porcentaje']; ?>%</li>
                  <li>Fondo B: $<?php echo $data['B']['valor']; ?> <?php echo $data['B']['porcentaje']; ?>%</li>
                  <li>Fondo C: $<?php echo $data['C']['valor']; ?> <?php echo $data['C']['porcentaje']; ?>%</li>
                  <li>Fondo D: $<?php echo $data['D']['valor']; ?> <?php echo $data['D']['porcentaje']; ?>%</li>
                  <li>Fondo E: $<?php echo $data['E']['valor']; ?> <?php echo $data['E']['porcentaje']; ?>%</li>
                </ul>
                <p>&nbsp;</p>
                <h3>Otras AFPs</<h3>
                <?php foreach ($otrasAFPs as $afpName => $data) : ?>
                <h2><?php echo "AFP $afpName"; ?></<h2>
                <ul>
                  <li>Fondo A: $<?php echo $data['A']['valor']; ?> <?php echo $data['A']['porcentaje']; ?>%</li>
                  <li>Fondo B: $<?php echo $data['B']['valor']; ?> <?php echo $data['B']['porcentaje']; ?>%</li>
                  <li>Fondo C: $<?php echo $data['C']['valor']; ?> <?php echo $data['C']['porcentaje']; ?>%</li>
          ...
          <tr>
            <td class="button">
              <div>
                <a class="button-mobile" href="https://www.fondosafp.com" style="background-color:#286090;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">
                  Ir a Fondos AFP
                </a>
              </div>
            </td>
        ...
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td style="padding: 25px 0 25px">
              <strong><a href="https://www.fondosafp.com">Fondos AFP</a></strong><br />
              <a href="https://www.twitter.com/FondosAFP">@FondosAFP</a> <br />
              <a href="mailto:your-email@domain.com">your-email@domain.com</a> <br /><br />
            </td>
          </tr>
        </table>
      </center>
  ...
  <tr>
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7; height: 100px;">
      <p style="font-size:10px; padding:20px;">
        Si no desea recibir mas este correo o si desea cambiar sus preferencias de env&iacute;o de correo electr&oacute;nico puede
        <a href="https://www.fondosafp.com/login?redirect=dashboard%23settings" title="actualizar sus preferencias" style="color:#000;font-weight:bold;">
          actualizar sus preferencias de env&iacute;o de correo electr&oacute;nico
        </a>
      </p>
    </td>
  </tr>
